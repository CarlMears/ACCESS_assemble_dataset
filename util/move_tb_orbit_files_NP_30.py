...
for orbit_set in range(0,12):
    ...
    dest_dir = Path(f'L:/access/amsr2_tb_orbits/NP_30/r{start_orbit:05d}_{end_orbit:05d}/')

    files = os.listdir(source_dir)
    files_to_move = [file for file in files if (('.polar_grid_tb.north.' in file) and ('030km' in file))]
