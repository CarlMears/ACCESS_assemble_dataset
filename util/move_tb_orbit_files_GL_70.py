...
for orbit_set in range(11, 16):
    ...
    dest_dir = Path(
        f"L:/access/amsr2_tb_orbits/GL_70/r{start_orbit:05d}_{end_orbit:05d}/"
    )

    files = os.listdir(source_dir)

    files_to_move = [
        file for file in files if ((".grid_tb." in file) and ("070km" in file))
    ]
    ...
    files_to_move = [
        file for file in files if (".time." in file)
    ]
