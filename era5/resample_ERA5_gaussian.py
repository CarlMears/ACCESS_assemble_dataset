...
if __name__ == "__main__":
    ...
    for latitude0 in np.arange(-88.0, 88.1, 0.25):
        ...
        for longitude0 in np.arange(0.0, 360.0, 0.25):
            ...
            # could use code here to wrap over the pole but
            # for now, only do -88 to 88
            ...
            # here are deprecated (including internally to
            # the package).  This needs to be cleaned up at
            # some point, but for now it works.
            #
            # construct a local projection, centered at the center of
            # the target gaussian.
            ...
            # normalization is done "by hand" later.
        ...
        nc_file = (
            ...
            f"resamp_wts_1440_721_rect_{int(footprint_diameter_km)}km.nc"
        )
