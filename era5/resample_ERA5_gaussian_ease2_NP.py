...
if __name__ == '__main__':
    ...
    for iy in np.arange(0,720):
        for ix in np.arange(0,720):
            ...
            ilon_edge_array[ilon_edge_array < 0] = ilon_edge_array[ilon_edge_array < 0] + 1440
            ilon_edge_array[ilon_edge_array > 1439] = ilon_edge_array[ilon_edge_array > 1439] - 1440
            ...
            indices_y,indices_x = np.unravel_index(np.argsort(footprint_amplitude,axis=None),footprint_amplitude.shape)
        ...
        nc_file = f'L:/access/era5/resample_weights/resamp_wts_ease2_25km_NP_{int(footprint_diameter_km)}km.nc'
